...
<head>
    ...
    <title>Práctica MySQL + phpdotenv · Listado de contactos</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>

<div class="box">
    <h1>Práctica MySQL + phpdotenv · Listado de contactos</h1>
    ...
    <div class="intro">
        ...
        <p>Aquí trabajamos el camino completo <strong>MySQL → PHP → HTML</strong>, pero con una configuración de entorno cargada mediante <code>phpdotenv</code>.</p>
    </div>
    ...
    <div class="mini-box">
        ...
        <ul>
            ...
            <li>Ese archivo ya no usa <code>parse_ini_file()</code>, sino <code>phpdotenv</code> y el autoload de Composer.</li>
    ...
    <div class="mini-box">
        ...
        <ul>
            ...
            <li>La configuración sensible se mantiene fuera del código en <code>.env</code>.</li>
        </ul>
    </div>
</div>
