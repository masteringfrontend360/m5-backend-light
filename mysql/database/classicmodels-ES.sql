...
CREATE TABLE IF NOT EXISTS t_cliente (
 numeroDeCliente int(11) NOT NULL,
 nombreDelCliente varchar(50) NOT NULL,
 apellidoDeLaPersonaDeContacto varchar(50) NOT NULL,
 nombreDeLaPersonaDeContacto varchar(50) NOT NULL,
 ...
 numeroDeEmpleadoDeRepresentanteDeVentas int(11) DEFAULT NULL,
 limiteDeCredito decimal(10,2) DEFAULT NULL,
 PRIMARY KEY (numeroDeCliente),
 KEY numeroDeEmpleadoDeRepresentanteDeVentas (numeroDeEmpleadoDeRepresentanteDeVentas)
);

INSERT INTO t_cliente(numeroDeCliente,nombreDelCliente,apellidoDeLaPersonaDeContacto,nombreDeLaPersonaDeContacto,telefono,direccionLinea1,direccionLinea2,ciudad,estado,codigoPostal,pais,numeroDeEmpleadoDeRepresentanteDeVentas,limiteDeCredito) values 
(103,'Atelier graphique','Sánchez','Carine ','40.32.2555','54, rue Royale',NULL,'Valencia',NULL,'44000','EspaÃ±a',1370,'21000.00'),
(112,'Signal Gift Stores','Reyes','Juana','+52 55 5555 1126','8489 Strong Calle',NULL,'CancÃºn','NV','83030','MÃ©xico',1166,'71800.00'),
(114,'Australian Collectors, Co.','Fernández','Pedro','03 9520 4555','636 St Kilda Camino','Level 3','ValparaÃ­so','Victoria','3004','Chile',1611,'117300.00'),
(119,'La Rochelle Gifts','Lagos','Janine ','40.67.8555','67, rue des Cinquante Otages',NULL,'Valencia',NULL,'44000','EspaÃ±a',1370,'118200.00'),
(121,'Baane Mini Imports','Bermúdez','Jonas ','07-98 9555','Erling Skakkes gate 78',NULL,'Punta del Este',NULL,'4110','Uruguay',1504,'81700.00'),
(124,'Mini Gifts Distributors Ltd.','Navarro','Susana','+52 55 5555 1141','5677 Strong Calle',NULL,'QuerÃ©taro','CA','97562','MÃ©xico',1165,'210500.00'),
(125,'Havel & Zbyszek Co','Prieto','Zbyszek ','(26) 642-7555','ul. Filtrowa 68',NULL,'Lima',NULL,'01-012','PerÃº',NULL,'0.00'),
(128,'Blauer See Auto, Co.','Quiroga','Rolando','+49 69 66 90 2555','Lyonerstr. 34',NULL,'Caracas',NULL,'60528','Venezuela',1504,'59700.00'),
(129,'Mini Wheels Co.','MuÑoz','Julia','+52 55 5555 1137','5557 North Pendale Calle',NULL,'Ciudad de MÃ©xico','CA','94217','MÃ©xico',1165,'64600.00'),
(131,'Land of Toys Inc.','León','Karina','+52 55 5555 1128','897 Long Airport Av.',NULL,'Monterrey','NY','10022','MÃ©xico',1323,'114900.00'),
(141,'Euro+ Shopping Channel','Freyre','Diego ','(91) 555 94 44','C/ Moralzarzal, 86',NULL,'Madrid',NULL,'28034','EspaÃ±a',1370,'227600.00'),
(144,'Volvo Model Replicas, Co','Beltrán','Christina ','0921-12 3555','Berguvsvägen 8',NULL,'Luleå',NULL,'S-958 22','Uruguay',1504,'53100.00'),
(145,'Danish Wholesale Imports','Pérez','Jytte ','31 12 3555','Vinbæltet 34',NULL,'Maldonado',NULL,'1734','Uruguay',1401,'83400.00'),
(146,'Saveley & Henriot, Co.','Salinas','Mary ','78.32.5555','2, rue du Commerce',NULL,'Barcelona',NULL,'69004','EspaÃ±a',1337,'123900.00'),
(148,'Dragon Souveniers, Ltd.','Natividad','Eric','+65 221 7555','Bronz Sok.','Bronz Apt. 3/6 Tesvikiye','Ciudad de PanamÃ¡',NULL,'079903','Ciudad de PanamÃ¡',1621,'103800.00'),
(151,'Muscle Machine Inc','YáÑez','Javier','+52 55 5555 1131','4092 Furth Circle','Suite 400','Monterrey','NY','10022','MÃ©xico',1286,'138500.00'),
(157,'Diecast Classics Inc.','López','Kevin','+52 55 5555 1131','7586 Pompton Calle',NULL,'LeÃ³n','PA','70267','MÃ©xico',1216,'100600.00'),
(161,'Technics Stores Inc.','Herrera','Julieta','+52 55 5555 1135','9408 Furth Circle',NULL,'Morelia','CA','94217','MÃ©xico',1165,'84600.00'),
(166,'Handji Gifts& Co','Victorino','Wendy','+65 224 1555','106 Linden Road Sandown','2nd Floor','Ciudad de PanamÃ¡',NULL,'069045','Ciudad de PanamÃ¡',1612,'97900.00'),
(167,'Herkku Gifts','Ortega','Vicente','+47 2267 3215','Brehmen St. 121','PR 334 Sentrum','Bergen',NULL,'N 5804','Norway ',1504,'96800.00'),
(168,'American Souvenirs Inc','Franco','Kevin','+52 55 5555 1136','149 Spinnaker Dr.','Suite 101','Toluca','CT','97823','MÃ©xico',1286,'0.00'),
(169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da saúde n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL,'0.00'),
(171,'Daedalus Designs Imports','Rancé','Martine ','20.16.1555','184, chaussée de Tournai',NULL,'Bilbao',NULL,'59000','EspaÃ±a',1370,'82900.00'),
(172,'La Corne D\'abondance, Co.','Belmonte','María','(1) 42.34.2555','265, boulevard Charonne',NULL,'Madrid',NULL,'75012','EspaÃ±a',1337,'84300.00'),
(173,'Cambridge Collectables Co.','Tovar','Gerardo','+52 55 5555 1135','4658 Baden Av.',NULL,'MÃ©rida','MA','51247','MÃ©xico',1188,'43400.00'),
(175,'Gift Depot Inc.','Reyes','Julia','+52 55 5555 1129','25593 South Bay Ln.',NULL,'Bridgewater','CT','97562','MÃ©xico',1323,'84300.00'),
(177,'Osaka Souveniers Co.','Quintero','Mauro','+81 06 6342 5555','1-6-20 Dojima',NULL,'Kita-ku','CÃ³rdoba',' 530-0003','Argentina',1621,'81200.00'),
(181,'Vitachrome Inc.','Flores','Miguel','+52 55 5555 1128','2678 Kingston Camino','Suite 101','Monterrey','NY','10022','MÃ©xico',1286,'76400.00'),
(186,'Toys of Finland, Co.','Carranza','Mateo','90-224 8555','Keskuskatu 45',NULL,'AsunciÃ³n',NULL,'21240','Paraguay',1501,'96500.00'),
(187,'AV Stores, Co.','Ãlvarez','Raquel','(171) 555-1555','Fauntleroy Circus',NULL,'MedellÃ­n',NULL,'EC2 5NT','Colombia',1501,'136800.00'),
(189,'Clover Collections, Co.','Casado','Daniel','+353 1862 1555','25 Maiden CallejÃ³n','Floor No. 4','Santo Domingo',NULL,'2','RepÃºblica Dominicana',1504,'69400.00'),
(198,'Auto-Moto Classics Inc.','Tapia','Leticia','+52 55 5555 1136','16780 Pompton Calle',NULL,'Puebla','MA','58339','MÃ©xico',1216,'23000.00'),
(201,'UK Collectables, Ltd.','Díaz','Isabel','(171) 555-2282','12, Berkeley Gardens Blvd',NULL,'Cali',NULL,'WX1 6LT','Colombia',1501,'92700.00'),
(202,'Canadian Gift Exchange Network','Tamayo','Yoshi ','(604) 555-3392','1900 Oak Calle',NULL,'San JosÃ©','BC','V3F 2K1','Costa Rica',1323,'90300.00'),
(204,'Online Mini Collectables','Barajas','Miguel','+52 55 5555 1139','7635 Spinnaker Dr.',NULL,'Puebla','MA','58339','MÃ©xico',1188,'68700.00'),
(205,'Toys4GrownUps.com','YáÑez','Julia','+52 55 5555 1127','78934 Hillside Dr.',NULL,'Tijuana','CA','90003','MÃ©xico',1166,'90700.00'),
(206,'Asian Shopping Network, Co','Paredes','Beatriz','+612 9411 1555','Suntec Tower Three','8 Temasek','Ciudad de PanamÃ¡',NULL,'038988','Ciudad de PanamÃ¡',NULL,'0.00'),
(209,'Mini Caravy','Cifuentes','Frédérique ','88.60.1555','24, place Kléber',NULL,'MÃ¡laga',NULL,'67000','EspaÃ±a',1370,'53800.00'),
(211,'King Kong Collectables, Co.','Galván','Miguel','+852 2251 1555','Bank of China Tower','1 Garden Camino','Ponce',NULL,NULL,'Puerto Rico',1621,'58600.00'),
(216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de Cataluña, 23',NULL,'Barcelona',NULL,'08022','EspaÃ±a',1702,'60300.00'),
(219,'Boards & Toys Co.','YáÑez','María','+52 55 5555 1125','4097 Douglas Av.',NULL,'Zapopan','CA','92561','MÃ©xico',1166,'11000.00'),
(223,'Natürlich Autos','Calos','Horst ','0372-555188','Taucherstraße 10',NULL,'Margarita',NULL,'01307','Venezuela',NULL,'0.00'),
(227,'Heintze Collectables','IbáÑez','Pablo','86 21 3555','Smagsloget 45',NULL,'Århus',NULL,'8200','Uruguay',1401,'120800.00'),
(233,'Québec Home Shopping Network','Fresnière','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'Montréal','Québec','H1J 1C3','Costa Rica',1286,'48700.00'),
(237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran Vía, 1',NULL,'Madrid',NULL,'28001','EspaÃ±a',NULL,'0.00'),
(239,'Collectable Mini Designs Co.','Torres','Valeria','+52 55 5555 1141','361 Furth Circle',NULL,'Mexicali','CA','91217','MÃ©xico',1166,'105000.00'),
(240,'giftsbymail.co.uk','Benítez','Helen ','(198) 555-8888','Garden House','Crowther Way 23','Barranquilla','Isle of Wight','PO31 7PJ','Colombia',1501,'93900.00'),
(242,'Alpha Cognac','Rojas','Annette ','61.77.6555','1 rue Alsace-Lorraine',NULL,'Zaragoza',NULL,'31000','EspaÃ±a',1370,'61100.00'),
(247,'Messner Shopping Network','Medina','Renate ','069-0555984','Magazinweg 7',NULL,'Caracas',NULL,'60528','Venezuela',NULL,'0.00'),
(249,'Amica Models & Co.','Acosta','Paolo ','011-4988555','Via Monte Bianco 34',NULL,'Quito',NULL,'10100','Ecuador',1401,'113000.00'),
(250,'Lyon Souveniers','Silva','Daniel','+33 1 46 62 7555','27 rue du Colonel Pierre Avia',NULL,'Madrid',NULL,'75508','EspaÃ±a',1337,'68100.00'),
(256,'Auto Associés & Cie.','Toledo','Daniel ','30.59.8555','67, avenue de l\'Europe',NULL,'Granada',NULL,'78000','EspaÃ±a',1370,'77900.00'),
(259,'Toms Spezialitäten, Ltd','Palacios','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'Köln',NULL,'50739','Venezuela',1504,'120400.00'),
(260,'Royal Canadian Collectables, Ltd.','Linares','Elizabeth ','(604) 555-4555','23 Tsawassen Bulevar',NULL,'Alajuela','BC','T2F 8M4','Costa Rica',1323,'89600.00'),
(273,'Franken Gifts, Co','Franco','Peter ','089-0877555','Berliner Platz 43',NULL,'München',NULL,'80805','Venezuela',NULL,'0.00'),
(276,'Anna\'s Decorations, Ltd','O\'Hara','Ana','02 9936 8555','201 Miller Calle','Level 15','ViÃ±a del Mar','NSW','2060','Chile',1611,'107800.00'),
(278,'Rovelli Gifts','Rovero','Giovanni ','035-640555','Via Ludovico il Moro 22',NULL,'Cuenca',NULL,'24100','Ecuador',1401,'119600.00'),
(282,'Souveniers And Things Co.','Huesca','Adrián','+61 2 9495 8555','Monitor Money Building','815 Pacific Hwy','Antofagasta','NSW','2067','Chile',1611,'93300.00'),
(286,'Marta\'s Replicas Co.','Hernández','Marta','+52 55 5555 1138','39323 Spinnaker Dr.',NULL,'MÃ©rida','MA','51247','MÃ©xico',1216,'123700.00'),
(293,'BG&E Collectables','Arias','Eduardo','+41 26 425 50 01','Rte des Arsenaux 41 ',NULL,'San Miguel',NULL,'1700','El Salvador',NULL,'0.00'),
(298,'Vida Sport, Ltd','Olmos','Miguel','0897-034555','Grenzacherweg 237',NULL,'Genève',NULL,'1203','El Salvador',1702,'141300.00'),
(299,'Norway Gifts By Mail, Co.','Clavijo','Juan','+47 2212 1555','Drammensveien 126A','PB 211 Sentrum','Oslo',NULL,'N 0106','Norway ',1504,'95100.00'),
(303,'Schuyler Imports','Suárez','Bernardo','+31 20 491 9555','Kingsfordweg 151',NULL,'Ciudad de Guatemala',NULL,'1043 GR','Guatemala',NULL,'0.00'),
(307,'Der Hund Imports','Andrade','Manuel','030-0074555','Obere Str. 57',NULL,'Maracaibo',NULL,'12209','Venezuela',NULL,'0.00'),
(311,'Oulu Toy Supplies, Inc.','Costas','Pilar','981-443655','Torikatu 38',NULL,'EncarnaciÃ³n',NULL,'90110','Paraguay',1501,'90500.00'),
(314,'Petit Auto','Duarte','Catherine ','(02) 5554 67','Rue Joseph-Bens 532',NULL,'Tegucigalpa',NULL,'B-1180','Honduras',1401,'79900.00'),
(319,'Mini Classics','Flores','Esteban','+52 55 5555 1138','3758 North Pendale Calle',NULL,'Cuernavaca','NY','24067','MÃ©xico',1323,'102700.00'),
(320,'Mini Creations Ltd.','Huerta','Walter','+52 55 5555 1133','4575 Hillside Dr.',NULL,'Veracruz','MA','50553','MÃ©xico',1188,'94500.00'),
(321,'Corporate Gift Ideas Co.','Blanco','Julia','+52 55 5555 1138','7734 Strong Calle',NULL,'Ciudad de MÃ©xico','CA','94217','MÃ©xico',1165,'105000.00'),
(323,'Down Under Souveniers, Inc','Granda','Miguel','+64 9 312 5555','162-164 Grafton Camino','Level 2','La Paz',NULL,NULL,'Bolivia',1612,'88000.00'),
(324,'Stylish Desk Decors, Co.','Blanco','Ann ','(171) 555-0297','35 King George',NULL,'BogotÃ¡',NULL,'WX3 6FW','Colombia',1501,'77000.00'),
(328,'Tekni Collectables Inc.','Blanco','Guillermo','+52 55 5555 1131','7476 Moss Camino',NULL,'Aguascalientes','NJ','94019','MÃ©xico',1323,'43000.00'),
(333,'Australian Gift Network, Co','Calleja','Benito','61-7-3844-6555','31 Duncan St. West End',NULL,'La Serena','Queensland','4101','Chile',1611,'51600.00'),
(334,'Suominen Souveniers','Suárez','Carlos','+358 9 8045 555','Software Engineering Center','SEC Oy','Ciudad del Este',NULL,'FIN-02271','Paraguay',1501,'98800.00'),
(335,'Cramer Spezialitäten, Ltd','Campos','Philip ','0555-09555','Maubelstr. 90',NULL,'MÃ©rida',NULL,'14776','Venezuela',NULL,'0.00'),
(339,'Classic Gift Ideas, Inc','Cervantes','Francisca','+52 55 5555 1143','782 First Calle',NULL,'San Luis PotosÃ­','PA','71270','MÃ©xico',1188,'81100.00'),
(344,'CAF Imports','Fernández','Jesús','+34 913 728 555','Merchants House','27-30 Merchant\'s Quay','Madrid',NULL,'28023','EspaÃ±a',1702,'59600.00'),
(347,'Men \'R\' US Retailers, Ltd.','Chaves','Braulio','+52 55 5555 1142','6047 Douglas Av.',NULL,'Ensenada','CA','91003','MÃ©xico',1166,'57700.00'),
(348,'Asian Treasures, Inc.','Macías','Patricia ','2967 555','8 Johnstown Camino',NULL,'Santiago','Co. Cork',NULL,'RepÃºblica Dominicana',NULL,'0.00'),
(350,'Marseille Mini Autos','Lebrija','Laurence ','91.24.4555','12, rue des Bouchers',NULL,'Sevilla',NULL,'13008','EspaÃ±a',1337,'65000.00'),
(353,'Reims Collectables','Enríquez','Paul ','26.47.1555','59 rue de l\'Abbaye',NULL,'Alicante',NULL,'51100','EspaÃ±a',1337,'81100.00'),
(356,'SAR Distributors, Co','Kruger','Armando','+27 21 550 3555','1250 Pretorius Calle',NULL,'Hatfield','Managua','0028','Guatemala',NULL,'0.00'),
(357,'GiftsForHim.com','Machado','Walter','64-9-3763555','199 Great North Camino',NULL,'La Paz',NULL,NULL,'Bolivia',1612,'77700.00'),
(361,'Kommission Auto','José','Karina','0251-555259','Luisenstr. 48',NULL,'Münster',NULL,'44087','Venezuela',NULL,'0.00'),
(362,'Gifts4AllAges.com','Yuste','Julieta','+52 55 5555 1127','8616 Spinnaker Dr.',NULL,'Guadalajara','MA','51003','MÃ©xico',1216,'41900.00'),
(363,'Online Diecast Creations Co.','YáÑez','Dorotea','+52 55 5555 1145','2304 Long Airport Av.',NULL,'Saltillo','NH','62005','MÃ©xico',1216,'114200.00'),
(369,'Lisboa Souveniers, Inc','Rodríguez','Lino ','(1) 354-2555','Jardim das rosas n. 32',NULL,'Lisboa',NULL,'1675','Portugal',NULL,'0.00'),
(376,'Precious Collectables','Urquiza','Bruno','0452-076555','Hauptstr. 29',NULL,'San Salvador',NULL,'3012','El Salvador',1702,'0.00'),
(379,'Collectables For Less Inc.','Navarro','Alfonso','+52 55 5555 1140','7825 Douglas Av.',NULL,'Puebla','MA','58339','MÃ©xico',1188,'70700.00'),
(381,'Royale Belge','Cartagena','Pascale ','(071) 23 67 2555','Boulevard Tirou, 255',NULL,'San Pedro Sula',NULL,'B-6000','Honduras',1401,'23500.00'),
(382,'Salzburg Collectables','Pizarro','Georg ','6562-9555','Geislweg 14',NULL,'Luque',NULL,'5020','Paraguay',1401,'71700.00'),
(385,'Cruz & Sons Co.','Cruz','Arnaldo','+63 2 555 3587','15 McCallum Calle','NatWest Center #13-03','Managua',NULL,'1227 MM','Nicaragua',1621,'81500.00'),
(386,'L\'ordine Souveniers','Moreno','Maurizio ','0522-556555','Strada Provinciale 124',NULL,'Loja',NULL,'42100','Ecuador',1401,'121400.00'),
(398,'Tokyo Collectables, Ltd','Solís','Alicia','+81 3 3584 0555','2-2-8 Roppongi',NULL,'Minato-ku','Buenos Aires','106-0032','Argentina',1621,'94400.00'),
(406,'Auto Canal+ Petit','Pereira','Domingo','(1) 47.55.6555','25, rue Lauriston',NULL,'Madrid',NULL,'75016','EspaÃ±a',1337,'95000.00'),
(409,'Stuttgart Collectable Exchange','Müller','Rita ','0711-555361','Adenauerallee 900',NULL,'Valencia',NULL,'70563','Venezuela',NULL,'0.00'),
(412,'Extreme Desk Decorations, Ltd','Monroy','Sara','04 499 9555','101 Lambton Quay','Level 11','Santa Cruz',NULL,NULL,'Bolivia',1612,'86800.00'),
(415,'Bavarian Collectables Imports, Co.','Domínguez','Miguel',' +49 89 61 08 9555','Hansastr. 15',NULL,'Munich',NULL,'80686','Venezuela',1504,'77000.00'),
(424,'Classic Legends Inc.','Hernández','Maria','+52 55 5555 1134','5905 Pompton Calle','Suite 750','Monterrey','NY','10022','MÃ©xico',1286,'67500.00'),
(443,'Feuer Online Stores, Inc','Ferrer','Alexander ','0342-555176','Heerstr. 22',NULL,'San CristÃ³bal',NULL,'04179','Venezuela',NULL,'0.00'),
(447,'Gift Ideas Corp.','Luis','Daniel','+52 55 5555 1124','2440 Pompton Calle',NULL,'Zapopan','CT','97561','MÃ©xico',1323,'49700.00'),
(448,'Scandinavian Gift Ideas','Larios','Marta','0695-34 6555','Åkergatan 24',NULL,'Bräcke',NULL,'S-844 67','Uruguay',1504,'116400.00'),
(450,'The Sharp Gifts Warehouse','Flores','Susana','+52 55 5555 1133','3086 Ingle Ln.',NULL,'San Jose','CA','94217','MÃ©xico',1165,'77600.00'),
(452,'Mini Auto Werke','Méndez','Roland ','7675-3555','Kirchgasse 6',NULL,'San Lorenzo',NULL,'8010','Paraguay',1401,'45300.00'),
(455,'Super Scale Inc.','MuÑoz','Leticia','+52 55 5555 1135','567 North Pendale Calle',NULL,'Toluca','CT','97823','MÃ©xico',1286,'95400.00'),
(456,'Microscale Inc.','Chocano','Yolanda','+52 55 5555 1138','5290 North Pendale Calle','Suite 200','Monterrey','NY','10022','MÃ©xico',1286,'39800.00'),
(458,'Corrida Auto Replicas, Ltd','Soria','Martín ','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','EspaÃ±a',1702,'104600.00'),
(459,'Warburg Exchange','Ortiz','Sven ','0241-039123','Walserweg 21',NULL,'Punto Fijo',NULL,'52066','Venezuela',NULL,'0.00'),
(462,'FunGiftIdeas.com','Benítez','Violeta','+52 55 5555 1132','1785 First Calle',NULL,'Veracruz','MA','50553','MÃ©xico',1216,'85800.00'),
(465,'Anton Designs, Ltd.','Antón','Carmen','+34 913 728555','c/ Gobelas, 19-1 Urb. La Florida',NULL,'Madrid',NULL,'28023','EspaÃ±a',NULL,'0.00'),
(471,'Australian Collectables, Ltd','Clemencia','Juan','61-9-3844-6555','7 Allen Calle',NULL,'ConcepciÃ³n','Victoria','3150','Chile',1611,'60300.00'),
(473,'Frau da Collezione','Rico','Franco','+39 022515555','20093 Cologno Monzese','Alessandro Volta 16','Guayaquil',NULL,NULL,'Ecuador',1401,'34800.00'),
(475,'West Coast Collectables Co.','Torres','Esteban','+52 55 5555 1138','3675 Furth Circle',NULL,'Burbank','CA','94019','MÃ©xico',1166,'55400.00'),
(477,'Mit Vergnügen & Co.','Mosquera','Hanna ','0621-08555','Forsterstr. 57',NULL,'Ciudad Guayana',NULL,'68306','Venezuela',NULL,'0.00'),
(480,'Kremlin Collectables, Co.','Serrano','Alexander ','+7 812 293 0521','2 Pobedy Square',NULL,'La Habana',NULL,'196143','Cuba',NULL,'0.00'),
(481,'Raanan Stores, Inc','Altagracia','Ramón','+ 972 9 959 8555','3 Hagalim Blv.',NULL,'San Juan',NULL,'47625','Puerto Rico',NULL,'0.00'),
(484,'Iberia Gift Imports, Corp.','Roel','José Pedro ','(95) 555 82 82','C/ Romero, 33',NULL,'Sevilla',NULL,'41101','EspaÃ±a',1702,'65700.00'),
(486,'Motor Mint Distributors Inc.','Salazar','Rosa','+52 55 5555 1142','11328 Douglas Av.',NULL,'San Luis PotosÃ­','PA','71270','MÃ©xico',1323,'72600.00'),
(487,'Signal Collectibles Ltd.','Tapia','Susana','+52 55 5555 1134','2793 Furth Circle',NULL,'La Paz','CA','94217','MÃ©xico',1165,'60300.00'),
(489,'Double Decker Gift Stores, Ltd','Herrero','Thomas ','(171) 555-7555','120 Hanover Sq.',NULL,'BogotÃ¡',NULL,'WA1 1DP','Colombia',1501,'43300.00'),
(495,'Diecast Collectables','Franco','Valeria','+52 55 5555 1127','6251 Ingle Ln.',NULL,'Guadalajara','MA','51003','MÃ©xico',1188,'85100.00'),
(496,'Kelly\'s Gift Shop','Soto','Antonio','+64 9 5555500','Arenales 1938 3\'A\'',NULL,'La Paz',NULL,NULL,'Bolivia',1612,'110000.00');
...
CREATE TABLE IF NOT EXISTS t_empleado (
 ...
 codigoDeOficina varchar(10) NOT NULL,
 reportaA int(11) DEFAULT NULL,
 tituloDelTrabajo varchar(50) NOT NULL,
 PRIMARY KEY (numeroDeEmpleado),
 KEY reportaA (reportaA),
 KEY codigoDeOficina (codigoDeOficina)
);


INSERT INTO t_empleado(numeroDeEmpleado,apellido,nombre,extension,email,codigoDeOficina,reportaA,tituloDelTrabajo) values 
(1002,'MuÑoz','Diana','x5800','dmurphy@classicmodelcars.com','1',NULL,'President'),
(1056,'Pérez','María','x4611','mpatterso@classicmodelcars.com','1',1002,'VP Sales'),
(1076,'Fernández','Javier','x9273','jfirrelli@classicmodelcars.com','1',1002,'VP Marketing'),
(1088,'Pérez','Guillermo','x4871','wpatterson@classicmodelcars.com','6',1056,'Sales Manager (APAC)'),
(1102,'Bonilla','Gerardo','x5408','gbondur@classicmodelcars.com','4',1056,'Sale Manager (EMEA)'),
(1143,'Barberá','Antonio','x5428','abow@classicmodelcars.com','1',1056,'Sales Manager (NA)'),
(1165,'Jiménez','Leticia','x3291','ljennings@classicmodelcars.com','1',1143,'Sales Rep'),
(1166,'Torres','Leticia','x4065','lthompson@classicmodelcars.com','1',1143,'Sales Rep'),
(1188,'Fernández','Julia','x2173','jfirrelli@classicmodelcars.com','2',1143,'Sales Rep'),
(1216,'Pérez','Esteban','x4334','spatterson@classicmodelcars.com','2',1143,'Sales Rep'),
(1286,'Tovar','Fátima','x2248','ftseng@classicmodelcars.com','3',1143,'Sales Rep'),
(1323,'Vargas','Jorge','x4102','gvanauf@classicmodelcars.com','3',1143,'Sales Rep'),
(1337,'Bonilla','Luis','x6493','lbondur@classicmodelcars.com','4',1102,'Sales Rep'),
(1370,'Hernández','Gerardo','x2028','ghernande@classicmodelcars.com','4',1102,'Sales Rep'),
(1401,'Castillo','Pamela','x2759','pcastillo@classicmodelcars.com','4',1102,'Sales Rep'),
(1501,'Botero','Lorenzo','x2311','lbott@classicmodelcars.com','7',1102,'Sales Rep'),
(1504,'Juárez','Bartolomé','x102','bjones@classicmodelcars.com','7',1102,'Sales Rep'),
(1611,'Ferrer','Andrés','x101','afixter@classicmodelcars.com','6',1088,'Sales Rep'),
(1612,'Marín','Pedro','x102','pmarsh@classicmodelcars.com','6',1088,'Sales Rep'),
(1619,'Reyes','Tomás','x103','tking@classicmodelcars.com','6',1088,'Sales Rep'),
(1621,'NúÑez','Marisol','x101','mnishi@classicmodelcars.com','5',1056,'Sales Rep'),
(1625,'Castro','Yolanda','x102','ykato@classicmodelcars.com','5',1621,'Sales Rep'),
(1702,'Gerardo','Martín','x2312','mgerard@classicmodelcars.com','4',1102,'Sales Rep');
...
CREATE TABLE IF NOT EXISTS t_oficina (
 ...
 PRIMARY KEY (codigoDeOficina)
);


INSERT INTO t_oficina(codigoDeOficina,ciudad,telefono,direccionLinea1,direccionLinea2,estado,pais,codigoPostal,territorio) values 
('1','Ciudad de México','+52 55 5555 1001','Av. Reforma 222','Oficina 300','CDMX','México','06600','NA'),
('2','Guadalajara','+52 33 3615 2002','Av. Vallarta 2440','Piso 2','Jalisco','México','44100','NA'),
('3','Monterrey','+52 81 8340 3003','Paseo de los Leones 101','Local 5A','Nuevo León','México','64000','NA'),
('4','Madrid','+34 91 123 4567','Gran Vía 24',NULL,'Madrid','España','28013','EMEA'),
('5','Buenos Aires','+54 11 4321 5000','Av. Corrientes 1234',NULL,'CABA','Argentina','C1043','Latam'),
('6','Santiago','+56 2 2345 6789','Av. Providencia 3000','Oficina 202',NULL,'Chile','7500000','Latam'),
('7','Bogotá','+57 601 321 9876','Cra. 7 #72-41','Piso 7',NULL,'Colombia','110221','Latam');


CREATE TABLE IF NOT EXISTS t_linea_de_pedido (
 numeroDePedido int(11) NOT NULL,
 codigoDeProducto varchar(15) NOT NULL,
 cantidadPedida int(11) NOT NULL,
 precioUnitario decimal(10,2) NOT NULL,
 numeroDeLineaDePedido smallint(6) NOT NULL,
 PRIMARY KEY (numeroDePedido,codigoDeProducto),
 KEY codigoDeProducto (codigoDeProducto)
);


INSERT INTO t_linea_de_pedido(numeroDePedido,codigoDeProducto,cantidadPedida,precioUnitario,numeroDeLineaDePedido) values 
...
CREATE TABLE IF NOT EXISTS t_pedido (
 ...
 KEY numeroDeCliente (numeroDeCliente)
);


INSERT INTO t_pedido(numeroDePedido,fechaDePedido,fechaRequerida,fechaDeEnvio,estado,comentarios,numeroDeCliente) values 
...
CREATE TABLE IF NOT EXISTS t_pago (
 numeroDeCliente int(11) NOT NULL,
 numeroDeCheque varchar(50) NOT NULL,
 fechaDePago date NOT NULL,
 cantidad decimal(10,2) NOT NULL,
 PRIMARY KEY (numeroDeCliente,numeroDeCheque)
);


INSERT INTO t_pago(numeroDeCliente,numeroDeCheque,fechaDePago,cantidad) values 
...
CREATE TABLE IF NOT EXISTS t_linea_de_producto (
 lineaDeProducto varchar(50) NOT NULL,
 descripcionDeTexto varchar(4000) DEFAULT NULL,
 descripcionHtml mediumtext,
 imagen mediumblob,
 PRIMARY KEY (lineaDeProducto)
);


INSERT INTO t_linea_de_producto(lineaDeProducto,descripcionDeTexto,descripcionHtml,imagen) values 
...
CREATE TABLE IF NOT EXISTS t_producto (
 codigoDeProducto varchar(15) NOT NULL,
 nombreDeProducto varchar(70) NOT NULL,
 lineaDeProducto varchar(50) NOT NULL,
 escalaDelProducto varchar(10) NOT NULL,
 proveedorDelProducto varchar(50) NOT NULL,
 descripcionDelProducto text NOT NULL,
 cantidadEnStock smallint(6) NOT NULL,
 precioDeCompra decimal(10,2) NOT NULL,
 precioVentaSugerido decimal(10,2) NOT NULL,
 PRIMARY KEY (codigoDeProducto),
 KEY lineaDeProducto (lineaDeProducto)
);


INSERT INTO t_producto(codigoDeProducto,nombreDeProducto,lineaDeProducto,escalaDelProducto,proveedorDelProducto,descripcionDelProducto,cantidadEnStock,precioDeCompra,precioVentaSugerido) values 
...
ALTER TABLE t_cliente ADD CONSTRAINT t_cliente_ibfk_1 FOREIGN KEY (numeroDeEmpleadoDeRepresentanteDeVentas) REFERENCES t_empleado (numeroDeEmpleado);
ALTER TABLE t_empleado ADD CONSTRAINT t_empleado_ibfk_1 FOREIGN KEY (reportaA) REFERENCES t_empleado (numeroDeEmpleado);
ALTER TABLE t_empleado ADD CONSTRAINT t_empleado_ibfk_2 FOREIGN KEY (codigoDeOficina) REFERENCES t_oficina (codigoDeOficina);
ALTER TABLE t_linea_de_pedido ADD CONSTRAINT t_linea_de_pedido_ibfk_1 FOREIGN KEY (numeroDePedido) REFERENCES t_pedido (numeroDePedido);
ALTER TABLE t_linea_de_pedido ADD CONSTRAINT t_linea_de_pedido_ibfk_2 FOREIGN KEY (codigoDeProducto) REFERENCES t_producto (codigoDeProducto);
ALTER TABLE t_pago ADD CONSTRAINT t_pago_ibfk_1 FOREIGN KEY (numeroDeCliente) REFERENCES t_cliente (numeroDeCliente);
ALTER TABLE t_pedido ADD CONSTRAINT t_pedido_ibfk_1 FOREIGN KEY (numeroDeCliente) REFERENCES t_cliente (numeroDeCliente);
ALTER TABLE t_producto ADD CONSTRAINT t_producto_ibfk_1 FOREIGN KEY (lineaDeProducto) REFERENCES t_linea_de_producto (lineaDeProducto);
